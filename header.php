...
<header>
	<nav class="nav" aria-label="<?php echo esc_attr( kpibi__( 'Navigation principale' ) ); ?>">
		<div class="container nav-inner">
			...
			<a href="<?php echo esc_url( $kpibi_linkedin ); ?>" target="_blank" rel="noopener noreferrer" class="nav-linkedin" aria-label="<?php echo esc_attr( kpibi__( 'KPIBI sur LinkedIn' ) ); ?>">
			...
			<button class="hamburger" aria-label="<?php echo esc_attr( kpibi__( 'Ouvrir le menu' ) ); ?>" aria-expanded="false" aria-controls="mobile-menu" id="hamburger-btn">
...
<div class="mobile-menu" id="mobile-menu" role="dialog" aria-modal="true" aria-label="<?php echo esc_attr( kpibi__( 'Menu de navigation' ) ); ?>">
	<div class="mobile-menu-header">
		<?php kpibi_logo( 32 ); ?>
		<button class="mobile-menu-close" id="mobile-menu-close" aria-label="<?php echo esc_attr( kpibi__( 'Fermer le menu' ) ); ?>">&times;</button>
	</div>
	<nav>
		<?php
		wp_nav_menu(
